...
export async function Billing() {
  ...
  const { formatterToUSD } = formatCurrency()
  return (
    <>
      <Separator />
      <Card>
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {formatterToUSD(billing.projects.price)} (
                  {formatterToUSD(billing.projects.unit)} each)
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Amount of seat</TableCell>
                <TableCell className="text-right">
                  {billing.seats.amount}
                </TableCell>
                <TableCell className="text-right">
                  {formatterToUSD(billing.seats.price)} (
                  {formatterToUSD(billing.seats.unit)} each)
                </TableCell>
              </TableRow>
            </TableBody>
            <TableFooter>
